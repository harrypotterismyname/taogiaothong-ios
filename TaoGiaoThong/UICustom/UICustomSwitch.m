...
@synthesize on;
@synthesize tintColor, clippingView, leftLabel, rightLabel,rightText,leftText;
...
{
	if ((self=[super initWithFrame:CGRectMake(rect.origin.x,rect.origin.y,65,27)]))
	{
		//		self.clipsToBounds = YES;
		self.leftText = lText;
        self.rightText = rText;
...
-(void)awakeFromNib
{
	...
	[self setThumbImage:[UIImage imageNamed:@"bt-circle.png"] forState:UIControlStateNormal];
	[self setMinimumTrackImage:[UIImage imageNamed:@"bg-switch.png"] forState:UIControlStateNormal];
	[self setMaximumTrackImage:[UIImage imageNamed:@"bg-switch.png"] forState:UIControlStateNormal];
	...
	self.clippingView = [[UIView alloc] initWithFrame:CGRectMake(4,0,55,23)];
	...
	NSString *leftLabelText = NSLocalizedString(self.leftText,"Custom UISwitch ON label. If localized to empty string then I/O will be used");
	...
	self.leftLabel.frame = CGRectMake(8, 0, 20, 15);
	...
	NSString *rightLabelText = NSLocalizedString(self.rightText,"Custom UISwitch OFF label. If localized to empty string then I/O will be used");
	...
	self.rightLabel.frame = CGRectMake(80, 0, 20, 15);
